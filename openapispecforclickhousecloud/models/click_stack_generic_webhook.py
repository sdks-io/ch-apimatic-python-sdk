...
class ClickStackGenericWebhook(object):
    """Implementation of the 'ClickStackGenericWebhook' model.
    ...
    Attributes:
        ...
        body (str): Optional request body template
    ...
    def __init__(
        ...
        """Initialize a ClickStackGenericWebhook instance."""
