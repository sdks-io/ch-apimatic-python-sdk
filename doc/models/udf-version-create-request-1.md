...
| `mtype` | `str` | Required, Constant | **Value**: `"executable_pool"` |
| `pool_size` | `int` | Optional | **Default**: `3`<br><br>**Constraints**: `>= 1` |
| `max_command_execution_time` | `int` | Optional | **Default**: `10`<br><br>**Constraints**: `>= 1` |
...
from openapispecforclickhousecloud.models.udf_version_create_request_1 import UdfVersionCreateRequest1

udf_version_create_request_1 = UdfVersionCreateRequest1(
    upload_id='00001e2c-0000-0000-0000-000000000000',
