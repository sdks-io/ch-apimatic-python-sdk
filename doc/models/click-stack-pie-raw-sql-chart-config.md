...
| `display_type` | `str` | Required, Constant | Display as a pie chart.<br><br>**Value**: `"pie"` |
...
from openapispecforclickhousecloud.models.click_stack_pie_raw_sql_chart_config import ClickStackPieRawSqlChartConfig
from openapispecforclickhousecloud.models.output import Output

click_stack_pie_raw_sql_chart_config = ClickStackPieRawSqlChartConfig(
