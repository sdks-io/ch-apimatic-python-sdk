...
| `disable_tls` | `bool` | Optional | Disable TLS for the MySQL connection. Use with caution in production environments. Defaults to false when omitted.<br><br>**Default**: `False` |
...
from openapispecforclickhousecloud.models.click_pipe_mutate_my_sql_source import ClickPipeMutateMySqlSource
...
click_pipe_mutate_my_sql_source = ClickPipeMutateMySqlSource(
