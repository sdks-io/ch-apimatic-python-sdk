...
| `restore_target` | `datetime` | Required | The point in time at which to recover, as either date/time, named restore point, or a specific transaction ID. |
...
from openapispecforclickhousecloud.models.postgres_service_restore_request import PostgresServiceRestoreRequest
...
postgres_service_restore_request = PostgresServiceRestoreRequest(
    name='name0',
    restore_target=dateutil.parser.parse('2026-03-31T18:17:37Z'),
