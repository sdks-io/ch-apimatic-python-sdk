...
| `recent_executions` | [`List[PostgresQueryExecution]`](../../doc/models/postgres-query-execution.md) | Required | Recent individual executions matching the pattern. |
...
postgres_slow_query_pattern_detail = PostgresSlowQueryPatternDetail(
    recent_executions=[
