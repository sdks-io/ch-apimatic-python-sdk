...
from openapispecforclickhousecloud.models.authentication_16 import Authentication16
...
from openapispecforclickhousecloud.models.click_pipe_post_big_query_service_account_source import ClickPipePostBigQueryServiceAccountSource
...
click_pipe_post_big_query_service_account_source = ClickPipePostBigQueryServiceAccountSource(
    ...
    credentials=ServiceAccount(
        service_account_file='serviceAccountFile6',
        additional_properties={
            'exampleAdditionalProperty': jsonpickle.decode('{"key1":"val1","key2":"val2"}')
        }
    ),
    authentication=Authentication16.SERVICE_ACCOUNT,
