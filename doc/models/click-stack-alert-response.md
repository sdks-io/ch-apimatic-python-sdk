...
| `id` | `str` | Optional | Unique alert identifier. |
...
| `execution_errors` | [`List[ClickStackAlertExecutionError]`](../../doc/models/click-stack-alert-execution-error.md) | Optional | Errors recorded during the most recent alert execution, if any. |
...
from openapispecforclickhousecloud.models.state_3 import State3
from openapispecforclickhousecloud.models.threshold_type import ThresholdType

click_stack_alert_response = ClickStackAlertResponse(
    ...
    state=State3.ALERT,
    team_id='65f5e4a3b9e77c001a345678',
    created_at=dateutil.parser.parse('2023-01-01T00:00:00Z'),
    updated_at=dateutil.parser.parse('2023-01-01T00:00:00Z'),
