...
from openapispecforclickhousecloud.models.v_1_organizations_udfs_response import V1OrganizationsUdfsResponse

v_1_organizations_udfs_response = V1OrganizationsUdfsResponse(
    status=201,
    request_id='00000a1c-0000-0000-0000-000000000000',
    result=Udf(
