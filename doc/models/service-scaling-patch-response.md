...
service_scaling_patch_response = ServiceScalingPatchResponse(
    ...
    id='000005b8-0000-0000-0000-000000000000',
    name='name4',
    provider=Provider.GCP,
    region=Region.EASTUS2,
    state=State.SOFTDELETED,
