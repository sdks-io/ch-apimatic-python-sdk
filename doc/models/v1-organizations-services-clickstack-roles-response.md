...
from openapispecforclickhousecloud.models.v_1_organizations_services_clickstack_roles_response import V1OrganizationsServicesClickstackRolesResponse

v_1_organizations_services_clickstack_roles_response = V1OrganizationsServicesClickstackRolesResponse(
    status=200,
    request_id='00000aec-0000-0000-0000-000000000000',
    result=[
        ClickStackRole(
            id='id6',
            name='name6',
