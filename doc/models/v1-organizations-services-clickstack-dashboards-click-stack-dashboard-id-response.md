...
from openapispecforclickhousecloud.models.v_1_organizations_services_clickstack_dashboards_click_stack_dashboard_id_response import V1OrganizationsServicesClickstackDashboardsClickStackDashboardIdResponse
...
v_1_organizations_services_clickstack_dashboards_click_stack_dashboard_id_response = V1OrganizationsServicesClickstackDashboardsClickStackDashboardIdResponse(
    status=200,
    request_id='0000130e-0000-0000-0000-000000000000',
    result=ClickStackDashboardResponse(
        id='id6',
        name='name6',
        tiles=[
