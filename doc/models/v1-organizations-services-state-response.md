...
from openapispecforclickhousecloud.models.v_1_organizations_services_state_response import V1OrganizationsServicesStateResponse

v_1_organizations_services_state_response = V1OrganizationsServicesStateResponse(
    status=200,
    request_id='00001ab2-0000-0000-0000-000000000000',
    result=Service(
