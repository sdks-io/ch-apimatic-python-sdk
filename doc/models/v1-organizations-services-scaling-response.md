...
from openapispecforclickhousecloud.models.v_1_organizations_services_scaling_response import V1OrganizationsServicesScalingResponse

v_1_organizations_services_scaling_response = V1OrganizationsServicesScalingResponse(
    status=200,
    request_id='00001f86-0000-0000-0000-000000000000',
    result=Service(
