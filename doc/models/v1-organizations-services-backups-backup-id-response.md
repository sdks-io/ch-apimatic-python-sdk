...
from openapispecforclickhousecloud.models.v_1_organizations_services_backups_backup_id_response import V1OrganizationsServicesBackupsBackupIdResponse

v_1_organizations_services_backups_backup_id_response = V1OrganizationsServicesBackupsBackupIdResponse(
    status=200,
    request_id='00000b6a-0000-0000-0000-000000000000',
    result=Backup(
