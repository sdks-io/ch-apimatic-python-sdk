...
ScalingScheduleDeleteErrorBody: TypeAlias = (
    V1OrganizationsServicesScalingSchedule400Error1 | V1OrganizationsServicesScalingSchedule500Error1 | RawError
)


@dataclass(frozen=True, slots=True)
class _ScalingScheduleDeleteError:
    def map(self, response: HttpResponse) -> ScalingScheduleDeleteErrorBody:
...
scaling_schedule_delete_error_mapper: Final[ErrorMapper[ScalingScheduleDeleteErrorBody]] = _ScalingScheduleDeleteError()
