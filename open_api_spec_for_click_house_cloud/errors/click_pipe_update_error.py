...
ClickPipeUpdateErrorBody: TypeAlias = (
    V1OrganizationsServicesClickpipesClickPipeId400Error1
    | V1OrganizationsServicesClickpipesClickPipeId500Error1
    | RawError
)
...
class _ClickPipeUpdateError:
    def map(self, response: HttpResponse) -> ClickPipeUpdateErrorBody:
...
click_pipe_update_error_mapper: Final[ErrorMapper[ClickPipeUpdateErrorBody]] = _ClickPipeUpdateError()
