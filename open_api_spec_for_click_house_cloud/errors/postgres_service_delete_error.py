...
PostgresServiceDeleteErrorBody: TypeAlias = (
    V1OrganizationsPostgres400Error1 | V1OrganizationsPostgres500Error1 | RawError
)


@dataclass(frozen=True, slots=True)
class _PostgresServiceDeleteError:
    def map(self, response: HttpResponse) -> PostgresServiceDeleteErrorBody:
...
postgres_service_delete_error_mapper: Final[ErrorMapper[PostgresServiceDeleteErrorBody]] = _PostgresServiceDeleteError()
