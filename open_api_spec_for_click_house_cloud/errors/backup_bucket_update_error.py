...
BackupBucketUpdateErrorBody: TypeAlias = (
    V1OrganizationsServicesBackupBucket400Error1 | V1OrganizationsServicesBackupBucket500Error1 | RawError
)


@dataclass(frozen=True, slots=True)
class _BackupBucketUpdateError:
    def map(self, response: HttpResponse) -> BackupBucketUpdateErrorBody:
...
backup_bucket_update_error_mapper: Final[ErrorMapper[BackupBucketUpdateErrorBody]] = _BackupBucketUpdateError()
