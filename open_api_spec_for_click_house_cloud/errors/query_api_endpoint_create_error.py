...
QueryApiEndpointCreateErrorBody: TypeAlias = (
    V1OrganizationsServicesQueryApiEndpoints400Error1
    | V1OrganizationsServicesQueryApiEndpoints403Error1
    | V1OrganizationsServicesQueryApiEndpoints404Error1
    | V1OrganizationsServicesQueryApiEndpoints500Error1
...
class _QueryApiEndpointCreateError:
    def map(self, response: HttpResponse) -> QueryApiEndpointCreateErrorBody:
...
query_api_endpoint_create_error_mapper: Final[
    ErrorMapper[QueryApiEndpointCreateErrorBody]
] = _QueryApiEndpointCreateError()
