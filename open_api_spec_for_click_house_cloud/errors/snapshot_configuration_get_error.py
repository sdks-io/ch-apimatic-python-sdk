...
SnapshotConfigurationGetErrorBody: TypeAlias = (
    V1OrganizationsServicesSnapshotConfiguration400Error1
    | V1OrganizationsServicesSnapshotConfiguration500Error1
    | RawError
)
...
class _SnapshotConfigurationGetError:
    def map(self, response: HttpResponse) -> SnapshotConfigurationGetErrorBody:
...
snapshot_configuration_get_error_mapper: Final[
    ErrorMapper[SnapshotConfigurationGetErrorBody]
] = _SnapshotConfigurationGetError()
