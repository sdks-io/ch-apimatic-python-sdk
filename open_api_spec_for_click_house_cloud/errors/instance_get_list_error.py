...
InstanceGetListErrorBody: TypeAlias = V1OrganizationsServices400Error1 | V1OrganizationsServices500Error1 | RawError


@dataclass(frozen=True, slots=True)
class _InstanceGetListError:
    def map(self, response: HttpResponse) -> InstanceGetListErrorBody:
...
instance_get_list_error_mapper: Final[ErrorMapper[InstanceGetListErrorBody]] = _InstanceGetListError()
