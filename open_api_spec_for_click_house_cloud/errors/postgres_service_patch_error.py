...
PostgresServicePatchErrorBody: TypeAlias = (
    V1OrganizationsPostgres400Error1 | V1OrganizationsPostgres500Error1 | RawError
)


@dataclass(frozen=True, slots=True)
class _PostgresServicePatchError:
    def map(self, response: HttpResponse) -> PostgresServicePatchErrorBody:
...
postgres_service_patch_error_mapper: Final[ErrorMapper[PostgresServicePatchErrorBody]] = _PostgresServicePatchError()
