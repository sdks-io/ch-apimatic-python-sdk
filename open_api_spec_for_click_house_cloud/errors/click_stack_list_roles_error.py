...
ClickStackListRolesErrorBody: TypeAlias = (
    V1OrganizationsServicesClickstackRoles400Error1 | V1OrganizationsServicesClickstackRoles500Error1 | RawError
)


@dataclass(frozen=True, slots=True)
class _ClickStackListRolesError:
    def map(self, response: HttpResponse) -> ClickStackListRolesErrorBody:
...
click_stack_list_roles_error_mapper: Final[ErrorMapper[ClickStackListRolesErrorBody]] = _ClickStackListRolesError()
