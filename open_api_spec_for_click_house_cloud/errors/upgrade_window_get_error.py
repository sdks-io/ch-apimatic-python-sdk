...
UpgradeWindowGetErrorBody: TypeAlias = (
    V1OrganizationsServicesUpgradeWindow400Error1 | V1OrganizationsServicesUpgradeWindow500Error1 | RawError
)


@dataclass(frozen=True, slots=True)
class _UpgradeWindowGetError:
    def map(self, response: HttpResponse) -> UpgradeWindowGetErrorBody:
...
upgrade_window_get_error_mapper: Final[ErrorMapper[UpgradeWindowGetErrorBody]] = _UpgradeWindowGetError()
