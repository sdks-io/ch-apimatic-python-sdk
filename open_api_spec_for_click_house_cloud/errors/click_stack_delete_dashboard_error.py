...
ClickStackDeleteDashboardErrorBody: TypeAlias = (
    V1OrganizationsServicesClickstackDashboardsClickStackDashboardId400Error1
    | V1OrganizationsServicesClickstackDashboardsClickStackDashboardId500Error1
    | RawError
)
...
class _ClickStackDeleteDashboardError:
    def map(self, response: HttpResponse) -> ClickStackDeleteDashboardErrorBody:
...
click_stack_delete_dashboard_error_mapper: Final[
    ErrorMapper[ClickStackDeleteDashboardErrorBody]
] = _ClickStackDeleteDashboardError()
