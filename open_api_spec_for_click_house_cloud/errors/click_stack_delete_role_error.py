...
ClickStackDeleteRoleErrorBody: TypeAlias = (
    V1OrganizationsServicesClickstackRolesClickStackRoleId400Error1
    | V1OrganizationsServicesClickstackRolesClickStackRoleId500Error1
    | RawError
)
...
class _ClickStackDeleteRoleError:
    def map(self, response: HttpResponse) -> ClickStackDeleteRoleErrorBody:
...
click_stack_delete_role_error_mapper: Final[ErrorMapper[ClickStackDeleteRoleErrorBody]] = _ClickStackDeleteRoleError()
