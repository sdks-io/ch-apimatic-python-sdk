...
MemberGetListErrorBody: TypeAlias = V1OrganizationsMembers400Error1 | V1OrganizationsMembers500Error1 | RawError


@dataclass(frozen=True, slots=True)
class _MemberGetListError:
    def map(self, response: HttpResponse) -> MemberGetListErrorBody:
...
member_get_list_error_mapper: Final[ErrorMapper[MemberGetListErrorBody]] = _MemberGetListError()
