...
ClickStackUpdateSavedSearchErrorBody: TypeAlias = (
    V1OrganizationsServicesClickstackSavedSearchesClickStackSavedSearchId400Error1
    | V1OrganizationsServicesClickstackSavedSearchesClickStackSavedSearchId500Error1
    | RawError
)
...
class _ClickStackUpdateSavedSearchError:
    def map(self, response: HttpResponse) -> ClickStackUpdateSavedSearchErrorBody:
...
click_stack_update_saved_search_error_mapper: Final[
    ErrorMapper[ClickStackUpdateSavedSearchErrorBody]
] = _ClickStackUpdateSavedSearchError()
