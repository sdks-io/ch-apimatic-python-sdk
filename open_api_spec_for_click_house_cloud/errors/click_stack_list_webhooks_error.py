...
ClickStackListWebhooksErrorBody: TypeAlias = (
    V1OrganizationsServicesClickstackWebhooks400Error1 | V1OrganizationsServicesClickstackWebhooks500Error1 | RawError
)


@dataclass(frozen=True, slots=True)
class _ClickStackListWebhooksError:
    def map(self, response: HttpResponse) -> ClickStackListWebhooksErrorBody:
...
click_stack_list_webhooks_error_mapper: Final[
    ErrorMapper[ClickStackListWebhooksErrorBody]
] = _ClickStackListWebhooksError()
