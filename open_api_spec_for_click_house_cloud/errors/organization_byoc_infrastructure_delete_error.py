...
OrganizationByocInfrastructureDeleteErrorBody: TypeAlias = (
    V1OrganizationsByocInfrastructure400Error1 | V1OrganizationsByocInfrastructure500Error1 | RawError
)


@dataclass(frozen=True, slots=True)
class _OrganizationByocInfrastructureDeleteError:
    def map(self, response: HttpResponse) -> OrganizationByocInfrastructureDeleteErrorBody:
...
organization_byoc_infrastructure_delete_error_mapper: Final[
    ErrorMapper[OrganizationByocInfrastructureDeleteErrorBody]
] = _OrganizationByocInfrastructureDeleteError()
