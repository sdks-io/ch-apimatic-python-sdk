...
ClickStackDeleteSourceErrorBody: TypeAlias = (
    V1OrganizationsServicesClickstackSourcesClickStackSourceId400Error1
    | V1OrganizationsServicesClickstackSourcesClickStackSourceId500Error1
    | RawError
)
...
class _ClickStackDeleteSourceError:
    def map(self, response: HttpResponse) -> ClickStackDeleteSourceErrorBody:
...
click_stack_delete_source_error_mapper: Final[
    ErrorMapper[ClickStackDeleteSourceErrorBody]
] = _ClickStackDeleteSourceError()
