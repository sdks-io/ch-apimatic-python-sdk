...
ClickStackUpdateDashboardErrorBody: TypeAlias = (
    V1OrganizationsServicesClickstackDashboardsClickStackDashboardId400Error1
    | V1OrganizationsServicesClickstackDashboardsClickStackDashboardId500Error1
    | RawError
)
...
class _ClickStackUpdateDashboardError:
    def map(self, response: HttpResponse) -> ClickStackUpdateDashboardErrorBody:
...
click_stack_update_dashboard_error_mapper: Final[
    ErrorMapper[ClickStackUpdateDashboardErrorBody]
] = _ClickStackUpdateDashboardError()
