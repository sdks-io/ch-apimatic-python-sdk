...
PostgresServiceGetListErrorBody: TypeAlias = (
    V1OrganizationsPostgres400Error1 | V1OrganizationsPostgres500Error1 | RawError
)


@dataclass(frozen=True, slots=True)
class _PostgresServiceGetListError:
    def map(self, response: HttpResponse) -> PostgresServiceGetListErrorBody:
...
postgres_service_get_list_error_mapper: Final[
    ErrorMapper[PostgresServiceGetListErrorBody]
] = _PostgresServiceGetListError()
