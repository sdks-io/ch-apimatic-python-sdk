...
ClickStackCreateDashboardErrorBody: TypeAlias = (
    V1OrganizationsServicesClickstackDashboards400Error1
    | V1OrganizationsServicesClickstackDashboards500Error1
    | RawError
)
...
class _ClickStackCreateDashboardError:
    def map(self, response: HttpResponse) -> ClickStackCreateDashboardErrorBody:
...
click_stack_create_dashboard_error_mapper: Final[
    ErrorMapper[ClickStackCreateDashboardErrorBody]
] = _ClickStackCreateDashboardError()
