...
PostgresInstancePrometheusGetErrorBody: TypeAlias = (
    V1OrganizationsPostgresPrometheus400Error1 | V1OrganizationsPostgresPrometheus500Error1 | RawError
)


@dataclass(frozen=True, slots=True)
class _PostgresInstancePrometheusGetError:
    def map(self, response: HttpResponse) -> PostgresInstancePrometheusGetErrorBody:
...
postgres_instance_prometheus_get_error_mapper: Final[
    ErrorMapper[PostgresInstancePrometheusGetErrorBody]
] = _PostgresInstancePrometheusGetError()
