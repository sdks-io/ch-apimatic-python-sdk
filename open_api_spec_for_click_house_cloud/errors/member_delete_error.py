...
MemberDeleteErrorBody: TypeAlias = V1OrganizationsMembers400Error1 | V1OrganizationsMembers500Error1 | RawError


@dataclass(frozen=True, slots=True)
class _MemberDeleteError:
    def map(self, response: HttpResponse) -> MemberDeleteErrorBody:
...
member_delete_error_mapper: Final[ErrorMapper[MemberDeleteErrorBody]] = _MemberDeleteError()
