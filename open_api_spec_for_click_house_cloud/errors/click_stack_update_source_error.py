...
ClickStackUpdateSourceErrorBody: TypeAlias = (
    V1OrganizationsServicesClickstackSourcesClickStackSourceId400Error1
    | V1OrganizationsServicesClickstackSourcesClickStackSourceId500Error1
    | RawError
)
...
class _ClickStackUpdateSourceError:
    def map(self, response: HttpResponse) -> ClickStackUpdateSourceErrorBody:
...
click_stack_update_source_error_mapper: Final[
    ErrorMapper[ClickStackUpdateSourceErrorBody]
] = _ClickStackUpdateSourceError()
