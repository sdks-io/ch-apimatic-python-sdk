...
InstanceCreateErrorBody: TypeAlias = V1OrganizationsServices400Error1 | V1OrganizationsServices500Error1 | RawError


@dataclass(frozen=True, slots=True)
class _InstanceCreateError:
    def map(self, response: HttpResponse) -> InstanceCreateErrorBody:
...
instance_create_error_mapper: Final[ErrorMapper[InstanceCreateErrorBody]] = _InstanceCreateError()
