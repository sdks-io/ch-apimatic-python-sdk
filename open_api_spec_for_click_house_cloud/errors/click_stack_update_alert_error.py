...
ClickStackUpdateAlertErrorBody: TypeAlias = (
    V1OrganizationsServicesClickstackAlertsClickStackAlertId400Error1
    | V1OrganizationsServicesClickstackAlertsClickStackAlertId500Error1
    | RawError
)
...
class _ClickStackUpdateAlertError:
    def map(self, response: HttpResponse) -> ClickStackUpdateAlertErrorBody:
...
click_stack_update_alert_error_mapper: Final[
    ErrorMapper[ClickStackUpdateAlertErrorBody]
] = _ClickStackUpdateAlertError()
