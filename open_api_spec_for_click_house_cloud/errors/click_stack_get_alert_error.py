...
ClickStackGetAlertErrorBody: TypeAlias = (
    V1OrganizationsServicesClickstackAlertsClickStackAlertId400Error1
    | V1OrganizationsServicesClickstackAlertsClickStackAlertId500Error1
    | RawError
)
...
class _ClickStackGetAlertError:
    def map(self, response: HttpResponse) -> ClickStackGetAlertErrorBody:
...
click_stack_get_alert_error_mapper: Final[ErrorMapper[ClickStackGetAlertErrorBody]] = _ClickStackGetAlertError()
