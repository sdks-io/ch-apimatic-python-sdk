...
ClickPipeGetErrorBody: TypeAlias = (
    V1OrganizationsServicesClickpipesClickPipeId400Error1
    | V1OrganizationsServicesClickpipesClickPipeId500Error1
    | RawError
)
...
class _ClickPipeGetError:
    def map(self, response: HttpResponse) -> ClickPipeGetErrorBody:
...
click_pipe_get_error_mapper: Final[ErrorMapper[ClickPipeGetErrorBody]] = _ClickPipeGetError()
