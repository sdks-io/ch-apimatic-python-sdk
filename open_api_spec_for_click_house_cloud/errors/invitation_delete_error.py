...
InvitationDeleteErrorBody: TypeAlias = (
    V1OrganizationsInvitations400Error1 | V1OrganizationsInvitations500Error1 | RawError
)


@dataclass(frozen=True, slots=True)
class _InvitationDeleteError:
    def map(self, response: HttpResponse) -> InvitationDeleteErrorBody:
...
invitation_delete_error_mapper: Final[ErrorMapper[InvitationDeleteErrorBody]] = _InvitationDeleteError()
