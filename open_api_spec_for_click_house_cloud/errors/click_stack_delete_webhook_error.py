...
ClickStackDeleteWebhookErrorBody: TypeAlias = (
    V1OrganizationsServicesClickstackWebhooksClickStackWebhookId400Error1
    | V1OrganizationsServicesClickstackWebhooksClickStackWebhookId500Error1
    | RawError
)
...
class _ClickStackDeleteWebhookError:
    def map(self, response: HttpResponse) -> ClickStackDeleteWebhookErrorBody:
...
click_stack_delete_webhook_error_mapper: Final[
    ErrorMapper[ClickStackDeleteWebhookErrorBody]
] = _ClickStackDeleteWebhookError()
