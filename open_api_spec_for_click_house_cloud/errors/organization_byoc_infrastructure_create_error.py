...
OrganizationByocInfrastructureCreateErrorBody: TypeAlias = (
    V1OrganizationsByocInfrastructure400Error1 | V1OrganizationsByocInfrastructure500Error1 | RawError
)


@dataclass(frozen=True, slots=True)
class _OrganizationByocInfrastructureCreateError:
    def map(self, response: HttpResponse) -> OrganizationByocInfrastructureCreateErrorBody:
...
organization_byoc_infrastructure_create_error_mapper: Final[
    ErrorMapper[OrganizationByocInfrastructureCreateErrorBody]
] = _OrganizationByocInfrastructureCreateError()
