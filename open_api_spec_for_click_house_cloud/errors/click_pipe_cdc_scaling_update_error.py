...
ClickPipeCdcScalingUpdateErrorBody: TypeAlias = (
    V1OrganizationsServicesClickpipesCdcScaling400Error1
    | V1OrganizationsServicesClickpipesCdcScaling500Error1
    | RawError
)
...
class _ClickPipeCdcScalingUpdateError:
    def map(self, response: HttpResponse) -> ClickPipeCdcScalingUpdateErrorBody:
...
click_pipe_cdc_scaling_update_error_mapper: Final[
    ErrorMapper[ClickPipeCdcScalingUpdateErrorBody]
] = _ClickPipeCdcScalingUpdateError()
