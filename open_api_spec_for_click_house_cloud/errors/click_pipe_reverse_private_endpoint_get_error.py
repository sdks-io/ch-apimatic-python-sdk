...
ClickPipeReversePrivateEndpointGetErrorBody: TypeAlias = (
    V1OrganizationsServicesClickpipesReversePrivateEndpointsReversePrivateEndpointId400Error1
    | V1OrganizationsServicesClickpipesReversePrivateEndpointsReversePrivateEndpointId500Error1
    | RawError
)
...
class _ClickPipeReversePrivateEndpointGetError:
    def map(self, response: HttpResponse) -> ClickPipeReversePrivateEndpointGetErrorBody:
...
click_pipe_reverse_private_endpoint_get_error_mapper: Final[
    ErrorMapper[ClickPipeReversePrivateEndpointGetErrorBody]
] = _ClickPipeReversePrivateEndpointGetError()
