...
ClickPipeSettingsUpdateErrorBody: TypeAlias = (
    V1OrganizationsServicesClickpipesClickPipeIdSettings400Error1
    | V1OrganizationsServicesClickpipesClickPipeIdSettings500Error1
    | RawError
)
...
class _ClickPipeSettingsUpdateError:
    def map(self, response: HttpResponse) -> ClickPipeSettingsUpdateErrorBody:
...
click_pipe_settings_update_error_mapper: Final[
    ErrorMapper[ClickPipeSettingsUpdateErrorBody]
] = _ClickPipeSettingsUpdateError()
