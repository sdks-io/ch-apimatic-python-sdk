...
BackupConfigurationGetErrorBody: TypeAlias = (
    V1OrganizationsServicesBackupConfiguration400Error1 | V1OrganizationsServicesBackupConfiguration500Error1 | RawError
)


@dataclass(frozen=True, slots=True)
class _BackupConfigurationGetError:
    def map(self, response: HttpResponse) -> BackupConfigurationGetErrorBody:
...
backup_configuration_get_error_mapper: Final[
    ErrorMapper[BackupConfigurationGetErrorBody]
] = _BackupConfigurationGetError()
