...
QueryApiEndpointGetErrorBody: TypeAlias = (
    V1OrganizationsServicesQueryApiEndpointsEndpointId400Error1
    | V1OrganizationsServicesQueryApiEndpointsEndpointId403Error1
    | V1OrganizationsServicesQueryApiEndpointsEndpointId404Error1
    | V1OrganizationsServicesQueryApiEndpointsEndpointId500Error1
...
class _QueryApiEndpointGetError:
    def map(self, response: HttpResponse) -> QueryApiEndpointGetErrorBody:
...
query_api_endpoint_get_error_mapper: Final[ErrorMapper[QueryApiEndpointGetErrorBody]] = _QueryApiEndpointGetError()
