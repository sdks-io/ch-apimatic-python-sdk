...
InvitationGetListErrorBody: TypeAlias = (
    V1OrganizationsInvitations400Error1 | V1OrganizationsInvitations500Error1 | RawError
)


@dataclass(frozen=True, slots=True)
class _InvitationGetListError:
    def map(self, response: HttpResponse) -> InvitationGetListErrorBody:
...
invitation_get_list_error_mapper: Final[ErrorMapper[InvitationGetListErrorBody]] = _InvitationGetListError()
