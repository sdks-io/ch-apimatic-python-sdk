...
InvitationGetErrorBody: TypeAlias = V1OrganizationsInvitations400Error1 | V1OrganizationsInvitations500Error1 | RawError


@dataclass(frozen=True, slots=True)
class _InvitationGetError:
    def map(self, response: HttpResponse) -> InvitationGetErrorBody:
...
invitation_get_error_mapper: Final[ErrorMapper[InvitationGetErrorBody]] = _InvitationGetError()
