...
class ClickPipePostKafkaSource(SdkBaseModel):
    ...
    schema_registry: OptionalNullable[ClickPipeMutateKafkaSchemaRegistry] = Field(default=UNSET, alias="schemaRegistry")
    ...
    """Base64-encoded .proto source or serialized FileDescriptorSet. Supported only with Protobuf format and cannot be
    combined with schemaRegistry."""


class ClickPipePostKafkaSourceDict(TypedDict):
    ...
    schema_registry: NotRequired[ClickPipeMutateKafkaSchemaRegistryDict | None]
