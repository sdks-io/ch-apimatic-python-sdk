...
class ClickPipePostPubSubServiceAccountSource(SdkBaseModel):
    format: Format6OrStr
    ...
    service_account_key: ServiceAccount = Field(alias="serviceAccountKey")


class ClickPipePostPubSubServiceAccountSourceDict(TypedDict):
    format: Format6OrStr
    project_id: str
    topic: str
    ...
    service_account_key: ServiceAccountDict
