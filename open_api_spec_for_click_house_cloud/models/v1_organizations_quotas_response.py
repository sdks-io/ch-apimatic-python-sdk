...
class V1OrganizationsQuotasResponse(SdkBaseModel):
    ...
    result: Optional[list[OrganizationQuota]] = UNSET


class V1OrganizationsQuotasResponseDict(TypedDict):
    status: NotRequired[float]
    request_id: NotRequired[UUID]
    result: NotRequired[list[OrganizationQuotaDict]]
