...
class V1OrganizationsActivitiesResponse1(SdkBaseModel):
    ...
    result: Optional[Activity] = UNSET


class V1OrganizationsActivitiesResponse1Dict(TypedDict):
    status: NotRequired[float]
    request_id: NotRequired[UUID]
    result: NotRequired[ActivityDict]
