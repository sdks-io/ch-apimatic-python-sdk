...
class V1OrganizationsServicesClickhouseSettingsResponse1(SdkBaseModel):
    ...
    result: Optional[ServiceClickhouseSettingsPatchResponse] = UNSET


class V1OrganizationsServicesClickhouseSettingsResponse1Dict(TypedDict):
    status: NotRequired[float]
    request_id: NotRequired[UUID]
    result: NotRequired[ServiceClickhouseSettingsPatchResponseDict]
