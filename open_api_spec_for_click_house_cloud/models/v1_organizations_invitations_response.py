...
class V1OrganizationsInvitationsResponse(SdkBaseModel):
    ...
    result: Optional[list[Invitation]] = UNSET


class V1OrganizationsInvitationsResponseDict(TypedDict):
    status: NotRequired[float]
    request_id: NotRequired[UUID]
    result: NotRequired[list[InvitationDict]]
