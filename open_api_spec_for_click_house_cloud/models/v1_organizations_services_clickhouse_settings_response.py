...
class V1OrganizationsServicesClickhouseSettingsResponse(SdkBaseModel):
    ...
    result: Optional[ServiceClickhouseSettingsList] = UNSET


class V1OrganizationsServicesClickhouseSettingsResponseDict(TypedDict):
    status: NotRequired[float]
    request_id: NotRequired[UUID]
    result: NotRequired[ServiceClickhouseSettingsListDict]
