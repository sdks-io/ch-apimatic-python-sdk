...
class V1OrganizationsResponse1(SdkBaseModel):
    ...
    result: Optional[Organization] = UNSET


class V1OrganizationsResponse1Dict(TypedDict):
    status: NotRequired[float]
    request_id: NotRequired[UUID]
    result: NotRequired[OrganizationDict]
