...
class V1OrganizationsServicesScalingResponse(SdkBaseModel):
    ...
    result: Optional[Service] = UNSET


class V1OrganizationsServicesScalingResponseDict(TypedDict):
    status: NotRequired[float]
    request_id: NotRequired[UUID]
    result: NotRequired[ServiceDict]
