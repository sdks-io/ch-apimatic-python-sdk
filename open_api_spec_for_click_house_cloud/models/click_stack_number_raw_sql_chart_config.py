...
from .enums.color5 import Color5OrStr


class ClickStackNumberRawSqlChartConfig(SdkBaseModel):
    ...
    color: Optional[Color5OrStr] = UNSET
    """Optional static color applied to the displayed number. Raw SQL number tiles do not support conditional
    colorRules."""


class ClickStackNumberRawSqlChartConfigDict(TypedDict):
