...
class V1OrganizationsKeysResponse1(SdkBaseModel):
    ...
    result: Optional[ApiKeyPostResponse] = UNSET


class V1OrganizationsKeysResponse1Dict(TypedDict):
    status: NotRequired[float]
    request_id: NotRequired[UUID]
    result: NotRequired[ApiKeyPostResponseDict]
