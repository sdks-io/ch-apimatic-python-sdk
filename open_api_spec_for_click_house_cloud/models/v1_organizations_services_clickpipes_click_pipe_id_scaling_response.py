...
class V1OrganizationsServicesClickpipesClickPipeIdScalingResponse(SdkBaseModel):
...
class V1OrganizationsServicesClickpipesClickPipeIdScalingResponseDict(TypedDict):
