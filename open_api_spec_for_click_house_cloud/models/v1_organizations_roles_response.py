...
class V1OrganizationsRolesResponse(SdkBaseModel):
    ...
    result: Optional[list[Rbacrole]] = UNSET


class V1OrganizationsRolesResponseDict(TypedDict):
    status: NotRequired[float]
    request_id: NotRequired[UUID]
    result: NotRequired[list[RbacroleDict]]
