...
class V1OrganizationsServicesPasswordResponse(SdkBaseModel):
    ...
    result: Optional[ServicePasswordPatchResponse] = UNSET


class V1OrganizationsServicesPasswordResponseDict(TypedDict):
    status: NotRequired[float]
    request_id: NotRequired[UUID]
    result: NotRequired[ServicePasswordPatchResponseDict]
