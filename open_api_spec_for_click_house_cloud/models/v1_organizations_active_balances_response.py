...
class V1OrganizationsActiveBalancesResponse(SdkBaseModel):
    ...
    result: Optional[ActiveBalances] = UNSET


class V1OrganizationsActiveBalancesResponseDict(TypedDict):
    status: NotRequired[float]
    request_id: NotRequired[UUID]
    result: NotRequired[ActiveBalancesDict]
