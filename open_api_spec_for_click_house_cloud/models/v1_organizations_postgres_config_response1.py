...
class V1OrganizationsPostgresConfigResponse1(SdkBaseModel):
    ...
    result: Optional[PostgresInstanceUpdateConfigResponse] = UNSET


class V1OrganizationsPostgresConfigResponse1Dict(TypedDict):
    status: NotRequired[float]
    request_id: NotRequired[UUID]
    result: NotRequired[PostgresInstanceUpdateConfigResponseDict]
