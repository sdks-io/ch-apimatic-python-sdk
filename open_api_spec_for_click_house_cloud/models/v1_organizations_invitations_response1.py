...
class V1OrganizationsInvitationsResponse1(SdkBaseModel):
    ...
    result: Optional[Invitation] = UNSET


class V1OrganizationsInvitationsResponse1Dict(TypedDict):
    status: NotRequired[float]
    request_id: NotRequired[UUID]
    result: NotRequired[InvitationDict]
