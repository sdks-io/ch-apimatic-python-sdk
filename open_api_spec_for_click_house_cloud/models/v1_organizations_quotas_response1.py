...
class V1OrganizationsQuotasResponse1(SdkBaseModel):
    ...
    result: Optional[OrganizationQuota] = UNSET


class V1OrganizationsQuotasResponse1Dict(TypedDict):
    status: NotRequired[float]
    request_id: NotRequired[UUID]
    result: NotRequired[OrganizationQuotaDict]
