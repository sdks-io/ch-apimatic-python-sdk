...
class V1OrganizationsActivitiesResponse(SdkBaseModel):
    ...
    result: Optional[list[Activity]] = UNSET


class V1OrganizationsActivitiesResponseDict(TypedDict):
    status: NotRequired[float]
    request_id: NotRequired[UUID]
    result: NotRequired[list[ActivityDict]]
