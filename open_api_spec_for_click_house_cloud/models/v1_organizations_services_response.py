...
class V1OrganizationsServicesResponse(SdkBaseModel):
    ...
    result: Optional[list[Service]] = UNSET


class V1OrganizationsServicesResponseDict(TypedDict):
    status: NotRequired[float]
    request_id: NotRequired[UUID]
    result: NotRequired[list[ServiceDict]]
