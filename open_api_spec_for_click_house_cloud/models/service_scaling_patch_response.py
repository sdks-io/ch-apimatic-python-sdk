...
class ServiceScalingPatchResponse(SdkBaseModel):
    ...
    autoscaling; equal to minReplicaMemoryGb in horizontal (memory is fixed while the replica count scales)."""
...
class ServiceScalingPatchResponseDict(TypedDict):
    id: NotRequired[UUID]
