...
class V1OrganizationsPostgresLogsResponse(SdkBaseModel):
    ...
    result: Optional[list[PostgresLogEntry]] = UNSET


class V1OrganizationsPostgresLogsResponseDict(TypedDict):
    status: NotRequired[float]
    request_id: NotRequired[UUID]
    result: NotRequired[list[PostgresLogEntryDict]]
