...
class ScimSchemaSubAttribute(SdkBaseModel):
    """A sub-attribute of a complex SCIM schema attribute. Per RFC 7643, sub-attributes cannot themselves have
    sub-attributes."""
...
class ScimSchemaSubAttributeDict(TypedDict):
    name: str
    type_: str
    multi_valued: bool
    description: str
