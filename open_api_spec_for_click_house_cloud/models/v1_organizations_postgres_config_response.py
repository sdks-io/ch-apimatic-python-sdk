...
class V1OrganizationsPostgresConfigResponse(SdkBaseModel):
    ...
    result: Optional[PostgresInstanceConfig] = UNSET


class V1OrganizationsPostgresConfigResponseDict(TypedDict):
    status: NotRequired[float]
    request_id: NotRequired[UUID]
    result: NotRequired[PostgresInstanceConfigDict]
