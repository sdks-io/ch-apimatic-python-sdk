...
class V1OrganizationsUsageCostResponse(SdkBaseModel):
    ...
    result: Optional[UsageCost] = UNSET


class V1OrganizationsUsageCostResponseDict(TypedDict):
    status: NotRequired[float]
    request_id: NotRequired[UUID]
    result: NotRequired[UsageCostDict]
